...
Community impact dashboard with visualizations showcasing trends based on semester,offense type, locations, reviewed reports.

## Potential Implementations:

- Using React.JS or another visualization library in a seperate page.

## Skills required:

JS, CSS, Firebase pulling
